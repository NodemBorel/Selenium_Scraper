...
while not isNextDisabled:
    try:
        element = WebDriverWait(browser, 50).until(EC.presence_of_element_located((By.XPATH, '//div[@data-component-type="s-search-result"]')))
        ...
        next_btn = WebDriverWait(browser, 50).until(EC.presence_of_element_located((By.CLASS_NAME, 's-pagination-next')))
